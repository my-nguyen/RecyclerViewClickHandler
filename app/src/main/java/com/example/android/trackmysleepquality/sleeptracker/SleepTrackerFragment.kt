...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val adapter = SleepNightAdapter(SleepNightListener { nightId ->
            ...
            // call the click handler onSleepNightClicked() when an item is tapped
        ...
        // observe navigateToSleepDetail: when it changes, navigate to the SleepDetailFragment,
        // passing in the night, then call onSleepDetailNavigated() afterwards
